...
A genuinely new authorization surface, distinct from every mechanism above: OAuth 2.0 authorization-code flows against two external providers (Google, Microsoft), where the "session" being protected belongs to a third party, not Beacon.
