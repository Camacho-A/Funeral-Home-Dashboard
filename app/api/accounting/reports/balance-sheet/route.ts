...
import { getBalanceSheet } from '@/services/financialReportsService';
import { getDataAdapterMode } from '@/lib/env';

/** Phase 31. Balance Sheet — gated `accounting.report`. */
export async function GET(request: Request) {
  ...
  const report = await getBalanceSheet(organizationId, dataAdapterMode, asOfDate);
